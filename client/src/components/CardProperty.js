...
import {faBath, faBed, faMapMarker, faRulerCombined, faTag,} from "@fortawesome/free-solid-svg-icons";
  ...
  return (
    <Card className="h-100 border-0 shadow">
      ...
      <Card.Body className="d-flex align-items-center">
        <div className="w-100">
          <Card.Title as="h6">
              <Link to={data.link} className="text-decoration-none text-dark">{data.title}</Link>
          </Card.Title>
