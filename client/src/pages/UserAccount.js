...
import dataAccount from "../data/user-account.json";
      ...
      <Header headerData={properties}/>
        <main>
            <section className="py-5">
                ...
                <h1 className="hero-heading mb-0">{dataAccount.title}</h1>
                <p className="text-muted mb-5">{dataAccount.subtitle}</p>
                <Row>
                    {dataAccount.cards.map((card) => (
